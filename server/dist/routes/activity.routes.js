 ...
 * @desc    Forward sales activity data to webhook
 * @access  Private
 */
router.post('/webhook', [
...
], validateRequest_1.validateRequest, activity_controller_1.forwardToWebhook);
/**
 * @route   POST /api/activities/create
 * @desc    Create a new sales activity record (legacy - direct to Supabase)
 * @access  Private
 */
router.post('/create', [
    (0, express_validator_1.body)('salesAgentId')
